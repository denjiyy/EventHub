...
export function EventCard({ event }: EventCardProps) {
  ...
  return (
    <div 
      onClick={() => navigate({ page: 'event-detail', id: event.id })}
    ...
    >
      <div className="relative overflow-hidden h-56">
        ...
        <div className="absolute top-4 left-4 right-4 flex items-start justify-between">
          ...
          {event.featured && (
            <div className="flex items-center gap-1 bg-amber-400 text-amber-900 px-2 py-1 rounded-full text-xs font-bold">
      ...
      <div className="p-6">
        ...
        <div className="mt-4 pt-4 border-t border-gray-100 flex items-center justify-between">
          <div className="flex items-center text-sm">
            ...
            <span className="text-gray-600">{event.availableTickets} left</span>
          </div>
